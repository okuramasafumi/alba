...
module CircularAssociationsControlExample
  class Author
  ...
  class AuthorResource
    ...
    attributes :name
    many :books, resource: 'CircularAssociationsControlExample::BookResource'
  end
  ...
  class BookResource
    ...
    root_key :book, :books
    attributes :title
    many :authors, resource: 'CircularAssociationsControlExample::AuthorResource'
  end
